...
<title>YÖNETİM | PANELİ | GİRİŞ</title>
                ...
                <div class="p-5">
                  ...
                  ?>
                    ...
                    <div class="form-group">
                      ...
                      Form::Olustur("2", array("type" => "text", "class" => "form-control form-control-user", 
                      "name" => "AdminAd", "autofocus" => "autofocus", "required" => "required",
                    ...
                    <div class="form-group">
                      ...
                      Form::Olustur("2", array("type" => "password", "class" => "form-control form-control-user", 
                      "name" => "Adminsifre", "required" => "required",
                    ...
                    <div class="form-group text-center">
                      ...
                      Form::Olustur("2", array("type" => "hidden",
                      "name" => "giristipi", "value" => "yon"));

                      Form::Olustur("2", array("type" => "submit", "value" => "GİRİŞ YAP",
                      "name" => "buton", "class" => "btn btn-danger"));
