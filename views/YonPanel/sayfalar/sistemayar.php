      ...
      ?>
          ...
          <div class="row text-left border-bottom-mvc mb-2">
            ...
            <div class="col-xl-12 col-md-12 mb-12 border-left-mvc text-left p-2 mb-2">
              <h1 class="h3 mb-0 text-gray-800"> <i class="fas fa-th basliktext"></i> SİSTEM AYARLARI </h1>
            </div>
              ...
              <div class="col-lg-10 col-xl-10 col-md-6 mx-auto">
                ...
                <div class="row bg-gradient-beyazimsi">
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12 bg-gradient-mvc pt-2 basliktext2">
                    <h3>Sistem Ayarlarını Güncelle</h3>
                  </div>
                  ...
                  <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="row">
                      ...
                      <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 bloklararasi">
                        <div class="row">
                        <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 uruneklemeElemanlarDiger">Sayfa Sloganları</div>
                          <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 uruneklemeElemanlar">Slogan Üst 1</div>
                          ...
                          <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 uruneklemeElemanlar">Slogan Alt 1</div>
                          <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">
                          ...
                          <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 uruneklemeElemanlar">Slogan Üst 2</div>
                          <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">
                          ...
                          <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 uruneklemeElemanlar">Slogan Alt 2</div>
                          <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">
                          ...
                          <div class="col-lg-3 col-xl-3 col-md-3 col-sm-12 uruneklemeElemanlar">Slogan Alt 3</div>
                          <div class="col-lg-9 col-xl-9 col-md-9 col-sm-12 uruneklemeElemanlarDiger">
                      ...
                      <div class="col-lg-6 col-xl-6 col-md-6 col-sm-12 ">
                        <div class="row">
                          ...
                          <?php Form::Olustur("3", array("class" => "form-control", "name" => "sayfatitle", "rows" => 3), $veri["sistemayar"][0]["title"]);  ?>
                          </div>

                          <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 uruneklemeElemanlarDiger">Sayfa Açıklama</div>
                          <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 uruneklemeElemanlarDiger"> 
                          <?php Form::Olustur("3", array("class" => "form-control", "name" => "sayfaaciklama", "rows" => 3), $veri["sistemayar"][0]["sayfaAciklama"]);  ?>
                          <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 uruneklemeElemanlarDiger">Anahtar Kelime</div>
                          <div class="col-lg-12 col-xl-12 col-md-12 col-sm-12 uruneklemeElemanlarDiger">
                          <?php Form::Olustur("3", array("class" => "form-control", "name" => "anahtarkelime", "rows" => 3), $veri["sistemayar"][0]["anahtarKelime"]);  ?>
                          </div>
